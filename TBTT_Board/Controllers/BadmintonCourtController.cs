...
namespace TBTT_Board.Controllers
{
    ...
    public class BadmintonCourtController : Controller
    {
        ...
        public BadmintonCourtController(ILogger<HomeController> logger, IAvailableRepository availableService, IWaitingRepository waitingService, IGameRepository gameService, ICourtRepository courtService, IMapper mapper, IConfiguration configuration, IMemberRepository memberService)
        {
            _logger = logger;
